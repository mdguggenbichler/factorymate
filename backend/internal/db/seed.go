...
var messageTypeCatalog = []messageTypeMeta{
	...
	{Key: "hub_tier_complete", Label: "HUB Tier Complete", Category: "progression", Variables: []string{"Timestamp", "ServerName", "TechTier", "MilestoneNames", "MilestoneCount"}},
	...
	{Key: "elevator_phase_complete", Label: "Elevator Phase Ready", Category: "progression", Variables: []string{"Timestamp", "ServerName", "ElevatorName", "PhaseNumber", "PhaseRequirements"}},
	{Key: "elevator_phase_done", Label: "Elevator Phase Complete", Category: "progression", Variables: []string{"Timestamp", "ServerName", "ElevatorName", "PhaseNumber", "PhaseRequirements"}},
	...
	{Key: "connection_details", Label: "Connection Details", Category: "server", Variables: []string{"Timestamp", "ServerName", "GameHost", "GamePort", "Notes"}},
}
